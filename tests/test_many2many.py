...
def populate_database(session: Session):
    ...
    hero_deadpond = HeroManyToMany(
        hero_name="Deadpond", secret_name="Dive Wilson", teams=[team_z_force, team_preventers]
    )
