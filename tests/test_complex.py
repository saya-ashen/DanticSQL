...
# Assume DanticSQL is in the same directory or installed
# from danticsql import DanticSQL
...
engine = create_engine(sqlite_url, echo=False, connect_args={"check_same_thread": False}) # echo=False to reduce noise
...
def populate_database():
    ...
    with Session(engine) as session:
        ...
        city_chicago = City(city_name="Chicago", state="IL")
...
def select_all_sql() -> pd.DataFrame:
...
def main():
    """Main function to set up DB, populate it, and run a test query."""
